        ...
        while (opcion != 6) {
            ...
            switch (opcion) {
                            ...
                            switch (opcionPensum) {
                                ...
                                case 5:
                                    while (opcionPensum > 0) {
                                        ...
                                        System.out.println("Haaa escogido una opción incorrecta, vuelva a intentarlo.");
                                    }
                                    break;
                                case 6:
                                    while (opcionPensum > 0) {
                ...
                case 5:
                    ...
                    while (opcion > 0) {
                        System.out.println(
                                "Estimado/a " + nombre + " . ¿Ya finalizó el noveno grado de bachiller?\n- Si\n- No");
                        String finalizoNovenoGrado = sc.next();
                        ...
                        } else if (finalizoNovenoGrado.toUpperCase().equals("NO")) {
                            System.out.println("Debes finalizar el grado noveno para poder realizar la inscripción.");
                        } else {
                            System.out.println("Ha ingresado una opción incorrecta, por favor vuelva a intentarlo.");
                        }

                        System.out.println("Presione 0 para retroceder");
                            retroceder = sc.nextInt();
                            sc.nextLine();
                        if (retroceder == 0) {
                            break;                            
